...
WIRE_GENERATOR_NAMESPACE="lodestar-cups-wire-generator-$$"
...
if (( EUID != 0 )); then
	printf 'Run the combined CUPS physical-wire generator wrapper as root.\n' >&2
	exit 1
fi
